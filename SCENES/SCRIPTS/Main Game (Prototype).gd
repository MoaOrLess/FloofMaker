...
# Unoptimized code for the floof maker game
# It looks looks like I want it to, but the code needs to be simplefied

# Features that I still need to be add:
# Save, load, export png, sfx, soundtrack, settings
...
#UI containers:
@onready var body_prefab: Node2D = $UI/FloofArt/BodyPrefab
@onready var scar_prefab: Node2D = $UI/FloofArt/ScarPrefab
@onready var eye_prefab: Node2D = $UI/FloofArt/EyePrefab
@onready var brow_prefab: Node2D = $UI/FloofArt/BrowPrefab
@onready var limb_prefab: Node2D = $UI/FloofArt/LimbPrefab
@onready var beard_prefab: Node2D = $UI/FloofArt/BeardPrefab
@onready var mouth_prefab: Node2D = $UI/FloofArt/MouthPrefab
@onready var nose_prefab: Node2D = $UI/FloofArt/NosePrefab
@onready var stash_prefab: Node2D = $UI/FloofArt/StashPrefab
@onready var hair_prefab: Node2D = $UI/FloofArt/HairPrefab
@onready var extra_prefab: Node2D = $UI/FloofArt/ExtraPrefab
...
const BROW_BUSHY = preload("res://ART/BROWS ART/Brow Bushy.png")
const BROW_ROUND = preload("res://ART/BROWS ART/Brow Round.png")
...
const EYE_ALMOND_IRIS = preload("res://ART/IRIS ART/Eye Almond Iris.png")
const EYE_ANIME_IRIS = preload("res://ART/IRIS ART/Eye Anime Iris.png")
const EYE_BIG_IRIS = preload("res://ART/IRIS ART/Eye Big Iris.png")
...
const EYE_INTENSE_IRIS = preload("res://ART/IRIS ART/Eye Intense Iris.png")
const EYE_KIRBY_IRIS = null
const EYE_LINE_IRIS = null
const EYE_REALISH_IRIS = preload("res://ART/IRIS ART/Eye Realish Iris.png")
const EYE_ROUND_IRIS = null
const EYE_SHARP_IRIS = preload("res://ART/IRIS ART/Eye Sharp Iris.png")
const EYE_STARE_IRIS = preload("res://ART/IRIS ART/Eye Stare Iris.png")
const EYE_TIC_TAC_IRIS = null
const EYE_TRAUMA_IRIS = null
const EYE_TWINKLE_IRIS = null
const EYE_U_IRIS = null
const EYE_WOBLE_IRIS = preload("res://ART/IRIS ART/Eye Woble Iris.png")
const FLOOF_GIDDY_IRIS = preload("res://ART/IRIS ART/Floof Giddy Iris.png")
...
const ARM_DOWN = preload("res://ART/LIMBS ART/ARM DOWN.png")
const ARM_PEACE = preload("res://ART/LIMBS ART/ARM PEACE.png")
const ARMS_ASYM = preload("res://ART/LIMBS ART/ARMS ASYM.png")
const ARMS_LEGS = preload("res://ART/LIMBS ART/ARMS LEGS.png")
const ARMS_SIDE = preload("res://ART/LIMBS ART/ARMS SIDE.png")
const ARMS_UP = preload("res://ART/LIMBS ART/ARMS UP.png")
const ARMS_UWU = preload("res://ART/LIMBS ART/ARMS UWU.png")
const ARMS_WAVE = preload("res://ART/LIMBS ART/ARMS WAVE.png")
...
const MOUTH_FUNNEL = preload("res://ART/MOUTH ART/Mouth Funnel.png")
...
const STASH_ARC = preload("res://ART/STASH ART/Stash Arc.png")
const STASH_BOOMERANG = preload("res://ART/STASH ART/Stash Boomerang.png")
const STASH_BRUSH = preload("res://ART/STASH ART/Stash Brush.png")
const STASH_CURL = preload("res://ART/STASH ART/Stash Curl.png")
const STASH_CURVE = preload("res://ART/STASH ART/Stash Curve.png")
const STASH_EVIL = preload("res://ART/STASH ART/Stash Evil.png")
const STASH_FRENCH = preload("res://ART/STASH ART/Stash French.png")
const STASH_LINES = preload("res://ART/STASH ART/Stash Lines.png")
const STASH_LONGTHIN = preload("res://ART/STASH ART/Stash Longthin.png")
const STASH_MARIO = preload("res://ART/STASH ART/Stash Mario.png")
const STASH_MONOPOLY = preload("res://ART/STASH ART/Stash Monopoly.png")
const STASH_MOP = preload("res://ART/STASH ART/Stash Mop.png")
const STASH_PENCIL = preload("res://ART/STASH ART/Stash Pencil.png")
const STASH_VILLAIN = preload("res://ART/STASH ART/Stash Villain.png")
const STASH_WHISKERS = preload("res://ART/STASH ART/Stash Whiskers.png")
const STASH_WIDE = preload("res://ART/STASH ART/Stash Wide.png")
const STASH_CHAPLIN = preload("res://ART/STASH ART/StashChaplin .png")

const BEARD_CHIN = preload("res://ART/BEARD/Beard Chin.png")
const BEARD_DORITO = preload("res://ART/BEARD/Beard Dorito.png")
const BEARD_GOAT = preload("res://ART/BEARD/Beard Goat.png")
const BEARD_LINEBROAD = preload("res://ART/BEARD/Beard Linebroad.png")
const BEARD_LINECHIN = preload("res://ART/BEARD/Beard Linechin.png")
const BEARD_LINEPATCH = preload("res://ART/BEARD/Beard Linepatch.png")
const BEARD_SHADOW = preload("res://ART/BEARD/Beard Shadow.png")
const BEARD_STUBBLE = preload("res://ART/BEARD/Beard Stubble.png")
const BEARD_WHOLE = preload("res://ART/BEARD/Beard Whole.png")

const EXTRA_BOW = preload("res://ART/EXTRA ART/Extra Bow.png")
const EXTRA_BOWLER_HAT = preload("res://ART/EXTRA ART/Extra BowlerHat.png")
const EXTRA_BOWY = preload("res://ART/EXTRA ART/Extra Bowy.png")
const EXTRA_CLIP = preload("res://ART/EXTRA ART/Extra Clip.png")
const EXTRA_FLOWER = preload("res://ART/EXTRA ART/Extra Flower.png")
const EXTRA_GLASSES = preload("res://ART/EXTRA ART/Extra Glasses.png")
const EXTRA_HALO = preload("res://ART/EXTRA ART/Extra Halo.png")
const EXTRA_HORN = preload("res://ART/EXTRA ART/Extra Horn.png")
const EXTRA_MONOCLE = preload("res://ART/EXTRA ART/Extra Monocle.png")

const HAIR_AHOGE = preload("res://ART/HAIR ART/hair Ahoge.png")
const HAIR_BANGS = preload("res://ART/HAIR ART/Hair Bangs.png")
const HAIR_BLOB = preload("res://ART/HAIR ART/Hair Blob.png")
const HAIR_COMBOVER = preload("res://ART/HAIR ART/Hair Combover.png")
const HAIR_CURL = preload("res://ART/HAIR ART/Hair Curl.png")
const HAIR_EMO = preload("res://ART/HAIR ART/Hair Emo.png")
const HAIR_HOMER = preload("res://ART/HAIR ART/Hair Homer.png")
const HAIR_MOHAWK = preload("res://ART/HAIR ART/Hair Mohawk.png")

const SCAR_BLUSH = preload("res://ART/SCAR ART/Scar Blush.png")
const SCAR_BOLT = preload("res://ART/SCAR ART/Scar Bolt.png")
const SCAR_CHEEKLINES = preload("res://ART/SCAR ART/Scar Cheeklines.png")
const SCAR_CHIN = preload("res://ART/SCAR ART/Scar Chin.png")
const SCAR_CROWS = preload("res://ART/SCAR ART/Scar Crows.png")
const SCAR_FRECKLES = preload("res://ART/SCAR ART/Scar Freckles.png")
const SCAR_MEW = preload("res://ART/SCAR ART/Scar Mew.png")
const SCAR_STITCH = preload("res://ART/SCAR ART/Scar Stitch.png")
const SCAR_WRINKLES = preload("res://ART/SCAR ART/Scar Wrinkles.png")
const SCAR_ZIGZAG = preload("res://ART/SCAR ART/Scar Zigzag.png")
...
MOUTH_SMUG, MOUTH_SSSSH, MOUTH_TOOF, MOUTH_TREE, MOUTH_V, MOUTH_W, MOUTH_FUNNEL ]

var BrowOption = [EMPTY, BROW_BLOCK, BROW_BRICK, BROW_CHONK, BROW_CLASSIC, BROW_FROWN, BROW_HAIRY,
BROW_HAT, BROW_INTENSE, BROW_PRESSED, BROW_ROUND_BLOCK, BROW_ROUNDISH, BROW_SHWONK, BROW_SLICK, BROW_SWOOP, BROW_TEAR, BROW_BUSHY, BROW_ROUND]
...
var TopStashOption = [EMPTY, STASH_ARC, STASH_BOOMERANG, STASH_BRUSH, STASH_CURL, STASH_CURVE,
STASH_EVIL, STASH_FRENCH, STASH_LINES, STASH_LONGTHIN, STASH_MARIO, STASH_MONOPOLY,
STASH_MOP, STASH_PENCIL, STASH_VILLAIN, STASH_WHISKERS, STASH_WIDE, STASH_CHAPLIN]

var BottomStashOption = [EMPTY, BEARD_CHIN, BEARD_DORITO, BEARD_GOAT, BEARD_LINEBROAD,
BEARD_LINECHIN, BEARD_LINEPATCH, BEARD_STUBBLE, BEARD_WHOLE]

var HairFrontOption = [EMPTY, HAIR_COMBOVER, HAIR_EMO, HAIR_HOMER, HAIR_MOHAWK, HAIR_AHOGE, HAIR_BANGS, HAIR_BLOB, HAIR_CURL]

var LimbOption = [EMPTY, ARM_DOWN, ARM_PEACE, ARMS_ASYM, ARMS_LEGS,ARMS_SIDE, ARMS_UP, ARMS_UWU, ARMS_WAVE]

var ScarOption = [EMPTY, SCAR_BLUSH, SCAR_BOLT, SCAR_CHEEKLINES, SCAR_CHIN, SCAR_CROWS, SCAR_FRECKLES, SCAR_MEW,SCAR_STITCH, SCAR_WRINKLES, SCAR_ZIGZAG]
...
func _ready() -> void:
	...
	scar_prefab.modulate = ColorOption[0]


# Called every frame. 'delta' is the elapsed time since the previous frame.
func _process(delta: float) -> void:
	#Move Floof Parts smoothly
	number_page() 
...
#FLOOF ANIMATION
#---------------------
func breathe_floof(sprite):
	var tween = create_tween()
	tween.tween_property(sprite, "scale", Vector2(1, 1.05), 2).set_trans(Tween.TRANS_SINE).set_ease(Tween.EASE_IN_OUT)
	tween.tween_property(sprite, "scale", Vector2(1, 1), 2).set_trans(Tween.TRANS_SINE).set_ease(Tween.EASE_IN_OUT)

func pos_floof(sprite):
	var tween = create_tween()
	tween.tween_property(sprite, "position", Vector2(0,-20), 2).set_trans(Tween.TRANS_SINE).set_ease(Tween.EASE_IN_OUT)
	tween.tween_property(sprite, "position", Vector2(0, 0), 2).set_trans(Tween.TRANS_SINE).set_ease(Tween.EASE_IN_OUT)

func animate_loop():
	while true:
		breathe_floof($UI/FloofArt) 
		pos_floof($UI/FloofArt)
		await get_tree().create_timer(5.0).timeout
#------------------

#CREATE BUTTONS: similar code for creating buttons for different categories (eyes, mouth, brows,...)
#---------------------
...
func create_stash_option_buttons():
	for index_on_page in 9:
		...
		hair_sprite.modulate = ColorOption[0]
		var index = index_on_page + (page * 9)
...
func create_beard_option_buttons():
	for index_on_page in 9:
		...
		beard_sprite.modulate = ColorOption[0]
		var index = index_on_page + (page * 9)
...
func create_limb_option_buttons():
	for index_on_page in 9: #Change back to 9
		...
		limb_sprite.modulate = ColorOption[0]
		var index = index_on_page + (page * 9)
...
func _on_page_down_pressed() -> void:
	...
	if current_category == Category.NOSE:
		if (page + 1) * 9 < NoseOption.size():
			...
			create_nose_option_buttons()
	if current_category == Category.STASH:
		if (page + 1) * 9 < TopStashOption.size(): 
	...
	if current_category == Category.ACCESSORY:
		if (page + 1) * 9 < ExtraOption.size():
			...
			create_extra_option_buttons()
	if current_category == Category.BEARD:
		if (page + 1) * 9 < BottomStashOption.size():
			page += 1
			clear_option_buttons()
			create_beard_option_buttons()
	if current_category == Category.LIMB:
		if (page + 1) * 9 < LimbOption.size():
			page += 1
			clear_option_buttons()
			create_limb_option_buttons()
	if current_category == Category.HAIR:
		if (page + 1) * 9 < HairFrontOption.size():
			page += 1
			clear_option_buttons()
			create_hair_option_buttons()

#Shows body sub categories
...
#Shows facialhair sub categories
...
func category_button_pressed(button, category_index):
	#Change the color of the category button
	if selected_button:
...
func color_sprite_change(color_index):
	...
	if category_index == Category.LIMB:
		limb_prefab.modulate = selected_color
	if category_index == Category.SCAR:
		scar_prefab.modulate = selected_color
...
#Change art when button is pressed
#------------------------
